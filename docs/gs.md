...
| Tool | Notes |
|---|---|
| QuestaSim / ModelSim | Tested with QuestaSim; other simulators not yet validated |
| Proprietary device models | Downloaded automatically by `make run` — **see license notice below** |
...
!!! note "Bender"
    ...
    [Bender releases page](https://github.com/pulp-platform/bender/releases).
...
We recommend [uv](https://docs.astral.sh/uv/) for fast, reproducible installs, but `pip` works too.
